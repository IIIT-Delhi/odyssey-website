...
var imagePath ;
    ...
    $rc.click(function() {
        ...
        switch (eventName) { 
            case 'byb': 
                imagePath = "http://www.fabricatingandmetalworking.com/wp-content/uploads/2014/01/iStock_000012962995Medium-e1390429283903.jpg";
                arrayOfRules = bybrules;
                description = byb;
                break;

            case 'drk': 
                imagePath = "http://farm1.staticflickr.com/143/370739622_9fe56e8734_o.jpg";
                arrayOfRules = dkrules;
                description =  drk;
                break;

            case 'ph':
                imagePath = "http://sourceenterprises.com/images/photography/photography.jpg";
                arrayOfRules = null;
                description =  ph;
                break;
            case 've':
                imagePath = "http://content.videoblocks.com/wp-content/uploads/2012/06/Cori%20Fowler%20-resized-600.jpg";
