...
"Obscenity strictly not allowed."]
	...
	$rc.click(function () {
		...
		switch (eventName) {
		case 'h':
			imagePath = "https://fbcdn-sphotos-b-a.akamaihd.net/hphotos-ak-xpf1/v/t1.0-9/10603764_974464592569417_3596639383661033603_n.jpg?oh=c2a73fc2888b9f90e9a1a2980064bed1&oe=552FE07F&__gda__=1430646037_9cb675e52eb4d7859b6a2d56351277ba    ";
			arrayOfRules = srules;
			description = s;
			break;
		case 's':
			imagePath = "https://drive.google.com/a/iiitd.ac.in/folderview?id=0B5y_pULQTWMIQ0R6d2dfdm1GZ1U&usp=sharing_eid";
			arrayOfRules = hrules;
			description = h;
			break;
