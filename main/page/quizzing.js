jQuery(document).ready(function($) {
	...
	var drk = "<h1>Dilli Walla Quiz</h1><p>This is a Quiz about all things Delhi. Meant to be a tribute to the culture of Delhi, the Quiz would cover everything – the Culture, the Heritage and the History of this majestic metropolis.</br>Duration: 3.5 Hours (1.5 for the prelims, 0.5 for checking, 1 for the finals, 0.5 Buffer)</p>";
...
var imagePath ;
    ...
    $rc.click(function() {
        ...
        switch (eventName) {
            case 'byb':
                imagePath = "culturatiBan.png";
                arrayOfRules = bybrules;
                description = byb;
                break;

            case 'drk':
                imagePath = "dilliwalaQuizBan.png";
                arrayOfRules = dkrules;
                description =  drk;
                break;

            case 'ph':
                imagePath = "generalQuizzingBan.png";
                arrayOfRules = phrules;
                description =  ph;
                break;
            case 've':
                imagePath = "fantasyQuizzingBan.png";
                arrayOfRules = null;
                description =  ve;
                break;
			case 'sports':
                imagePath = "sportsQuizBan.png";
                arrayOfRules = null;
                description =  sports;
                break;
