jQuery(document).ready(function($) {
    ...
    var fo = "<h1>Face Off</h1><br><br><p>Face it off on the pirate ship against your rivals. Prove your mettle. Aye, be so good, that the Captain just can’t ignore you!</p><br/><p>Fixtures:</p> <ul> <li>If there are odd number of teams in the first round, 3 teams will chosen at random which will battle it out on elimination basis and one will advance to the next round.</li><li>If an odd situation arises in any subsequent round, the 3 teams will be chosen by the judges.</li><li>Semis: If 3 teams remain, each team battles the other. 2 teams advance to finals. If 4 or 5 teams remain, normal procedure follows. 2 teams advance to finals</li><li>Finals: Knockout for the Winner!</li></ul>";
