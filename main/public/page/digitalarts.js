jQuery(document).ready(function($) {
    ...
    var ve = "<h1>Create-O-Flix</h1><br><br><p>The event is about blending your thoughts, ideas, creativity and into the form of an impressive video. And it is not as simple as clicking and dragging templates. </p>";
    
    var verules = ["The event would take place in two rounds : preliminary and final round.","A team of up to 4 are allowed to participate as a team. Lonewolves are also allowed. ","Every team needs to submit one video for preliminary round and if they qualify then another video for the final round. ","The preliminary round will be online. Final round will be on the campus of IIIT Delhi. The teams selected for final round need to submit their videos on the day of final round.  There would be a screening of all the videos and judging on that day.","The video entry for the preliminary round needs to be a video uploaded to YouTube. Only a link to the video will be required to be submitted for participation.","For the preliminary round there’s no restriction on the choice of topic. However, for the final round, teams will be given a topic beforehand.","The maximum length of video is 5 minutes for each round.","Only one entry per team is allowed. Multiple entries would lead to disqualification.","Be sure that any music, animation or any other media in your video is original. All entries would be tested for plagiarism. Any plagiarised content would lead to disqualification.","---Contact---<br>	Paarth Arora -> paarth14150@iiitd.ac.in :9999337522","Adesh Pandey -> adesh14004@iiitd.ac.in : 9899260375"]
